...
const UI_TEXT = {
  en: {
    ...
    markBlocked: "blocked",
    markEmpty: "empty",
    shareTitleDaily: "Daily Star Battle #{id}",
    shareTitlePractice: "Star Battle Practice #{id}",
  ...
  de: {
    ...
    markEmpty: "leer",
    shareTitleDaily: "Daily Star Battle #{id}",
    shareTitlePractice: "Star Battle Training #{id}",
  ...
  es: {
    ...
    markEmpty: "vacía",
    shareTitleDaily: "Daily Star Battle #{id}",
    shareTitlePractice: "Práctica Star Battle #{id}",
  ...
  fr: {
    ...
    markEmpty: "vide",
    shareTitleDaily: "Daily Star Battle #{id}",
    shareTitlePractice: "Entraînement Star Battle #{id}",
  ...
  ja: {
    ...
    markEmpty: "空き",
    shareTitleDaily: "Daily Star Battle #{id}",
    shareTitlePractice: "Star Battle 練習 #{id}",
  ...
  pt: {
    ...
    markEmpty: "vazia",
    shareTitleDaily: "Daily Star Battle #{id}",
    shareTitlePractice: "Treino Star Battle #{id}",
  ...
  zh: {
    ...
    markEmpty: "空格",
    shareTitleDaily: "Daily Star Battle #{id}",
    shareTitlePractice: "Star Battle 练习 #{id}",
    shareSolved: "{time} 完成",
    shareProgress: "进行中",
