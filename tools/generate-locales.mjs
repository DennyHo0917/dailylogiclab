...
const supportContent = {
  en: {
    ...
    privacy: {
      ...
      description: "Read the Daily Logic Lab privacy policy, including information about analytics, local browser storage, and cookies.",
      eyebrow: "Privacy",
      h1: "Privacy Policy",
  ...
  de: {
    ...
    privacy: {
      ...
      description: "Datenschutzhinweise zu Daily Logic Lab, einschließlich Analytics, lokalem Browserspeicher und Cookies.",
      eyebrow: "Datenschutz",
      ...
      sections: [
        ...
        { heading: "Nützliche Datenschutzlinks", links: [{ label: "Google-Datenschutzerklärung", href: "https://policies.google.com/privacy" }] }
      ]
    }
  },
  es: {
    ...
    privacy: {
      ...
      description: "Política de privacidad de Daily Logic Lab sobre analítica, almacenamiento local y cookies.",
      eyebrow: "Privacidad",
      h1: "Política de privacidad",
      updatedLabel: "Última actualización:",
      updatedDate: "12 de agosto de 2026",
      sections: [
        ...
        { heading: "Enlaces útiles", links: [{ label: "Privacidad de Google", href: "https://policies.google.com/privacy" }] }
      ]
    }
  },
  fr: {
    ...
    privacy: {
      ...
      description: "Politique de confidentialité de Daily Logic Lab concernant l'analytique, le stockage local et les cookies.",
      eyebrow: "Confidentialité",
      h1: "Politique de confidentialité",
      updatedLabel: "Dernière mise à jour :",
      updatedDate: "12 août 2026",
      sections: [
        ...
        { heading: "Liens utiles", links: [{ label: "Politique de confidentialité Google", href: "https://policies.google.com/privacy" }] }
      ]
    }
  },
  ja: {
    ...
    privacy: {
      ...
      description: "Daily Logic Lab の解析、ローカル保存、Cookie に関するプライバシーポリシー。",
      eyebrow: "プライバシー",
      h1: "プライバシーポリシー",
      updatedLabel: "最終更新:",
      ...
      sections: [
        ...
        { heading: "関連リンク", links: [{ label: "Google プライバシーポリシー", href: "https://policies.google.com/privacy" }] }
      ]
    }
  },
  pt: {
    ...
    privacy: {
      ...
      description: "Política de privacidade do Daily Logic Lab sobre analytics, armazenamento local e cookies.",
      eyebrow: "Privacidade",
      ...
      sections: [
        ...
        { heading: "Links úteis", links: [{ label: "Política de Privacidade do Google", href: "https://policies.google.com/privacy" }] }
      ]
    }
  },
  zh: {
    ...
    privacy: {
      ...
      description: "阅读 Daily Logic Lab 隐私政策，了解分析、浏览器本地存储和 Cookie 相关信息。",
      eyebrow: "隐私",
      h1: "隐私政策",
      updatedLabel: "最后更新：",
      updatedDate: "2026年8月12日",
      sections: [
        ...
        { heading: "相关链接", links: [{ label: "Google 隐私政策", href: "https://policies.google.com/privacy" }] }
      ]
    }
  }
};
...
function supportPage(language, pageKey) {
  ...
  const updated = pageKey === "privacy" ? `\n        <p><strong>${escapeHtml(content.updatedLabel)}</strong> ${escapeHtml(content.updatedDate)}</p>` : "";
  const cta = content.cta ? `\n        <p><a href="${content.cta.href}">${escapeHtml(content.cta.label)}</a></p>` : "";
